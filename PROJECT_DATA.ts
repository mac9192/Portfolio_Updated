...
export const PROJECT_DATA: Project[] = [
    ...
    },
    {
        ...
        badges: ["NextJs","Framer Motion", "Tailwind", "Google Analytics", "Cookie Banner", "Internationalization"],
        intro: "Soch Performance, a brake system company, needed a modern website to compete with high-end automobile brands. I aimed to create a visually appealing and functional online presence that effectively showcases their products.",
        techUsed:"To achieve this, I utilized a tech stack that included Next.js for performance, internationalization for diverse audiences, Tailwind CSS for rapid design, and Framer Motion for smooth animations. This combination allowed me to deliver a high-quality website tailored to their needs.",
        issues:"One major challenge was ensuring all design elements were finalized before coding to avoid later revisions. Additionally, I needed to maintain effective communication with the client, which required regular feedback and adjustments.",
        learned:"This project significantly improved my client communication skills and taught me how to manage expectations. I also gained confidence in my design abilities and learned to effectively transition concepts into code.",
        image: "/assets/sochP.webp",
        image1: "/assets/soch-1.png",
        image2: "/assets/soch-2.png",
        image3: "/assets/soch-3.png",
        image4: "/assets/soch-4.png",
        image5: "/assets/soch-5.png",
        slug:"soch-perforamnce",
        url:"https://sampledemo.website",
    },
    {
        id: "4",
